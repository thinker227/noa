...
| 0x20 | `PushList` | Pushes an empty list onto the stack. | Pushes 1 value |
...
| 0x48 | `StoreVarBoxed <var index: u32>` | Same as `StoreVar`, but ensured that the value is boxed before storing it into the variable. | Pops 1 value. |
